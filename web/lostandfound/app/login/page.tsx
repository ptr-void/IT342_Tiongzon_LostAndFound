...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    toast.info("Google OAuth implies a redirect...");
  };
        ...
        <form onSubmit={handleLogin} className="space-y-3">
          ...
          <CardFooter className="flex flex-col gap-4 mt-6 pb-6">
            ...
            <div className="text-center text-sm text-slate-500 w-full mb-2">
              ...
              <Link href="/register" className="text-amber-600 hover:underline hover:text-amber-700 font-medium font-sans">
                Sign up
              </Link>
            </div>
            ...
            <Button type="button" variant="outline" className="w-full hover:bg-slate-100 dark:hover:bg-slate-800" onClick={handleGoogleLogin}>
